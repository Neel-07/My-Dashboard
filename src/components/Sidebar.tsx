...
const Sidebar: React.FC = () => {
  return (
    <aside className="ml-8 mr-8 mt-10  w-64 h-full bg-indigo-600 p-4 flex flex-col space-y-4 rounded-lg shadow-lg">
      ...
      <button className="bg-indigo-400 py-2 px-4 rounded text-white">Option 1</button>
      <button className="bg-indigo-400 py-2 px-4 rounded text-white">Option 2</button>
      <button className="bg-indigo-400 py-2 px-4 rounded text-white">Option 3</button>
      <button className="bg-indigo-400 py-2 px-4 rounded text-white">Option 4</button>
